...
26. [Neuerungen in v3.0.6–v4.3.3 (Changelog)](#26-neuerungen-in-v306v420-changelog)
...
```
twitch-copilot-v4.3.3-source.tar
```
...
```
twitch-copilot-v4.3.3.tar              ← Die EINE Datei zum Download
├── twitch-copilot-v4.3.3-source.tar   ← Kompletter Source Code + README + CHANGELOG + VERSION
├── twitch-copilot-v4.3.3-static.tar   ← Production Build (dist/) + README + CHANGELOG + VERSION
